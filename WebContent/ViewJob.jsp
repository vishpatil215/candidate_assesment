                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="active">
                                    <a href="ViewJob.jsp" class="waves-effect waves-dark">
                                        ...
                                        <span class="pcoded-mtext">View Job</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                            </ul>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-block table-border-style">
                                                ...
                                                <%	Connection con=DbConnection.connect();
                                                	...
                                                	PreparedStatement pstmt=con.prepareStatement("select * from job where hid=?");
                                                	pstmt.setInt(1, Values.getHid());
                                                    ...
                                                    <table class="table table-hover">
                                                    	...
                                                    	{ %>
                                                            <tr>
                                                                ...
                                                                <td><a href="viewsr.jsp?id=<%=rs.getInt(1)%>">View Can</a>
                                                            </tr>
                                                             <%} %>
                                                        </tbody>
                                                    </table>
